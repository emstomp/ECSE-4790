...
//
// Lab 1 task 2
// Logs any printable character to the screen between lines 4 and 14, with a 4 space margin on the left
// and right of the screen, starting at the top-left region of the space. The log scrolls when more space
// is needed. When non-printable characters are pressed, text flashes with the following
// red text: “The received value $XX is ’not printable’.” A log of the number of printable
// and non-printable characters received is printed on the bottom left corner.
//
//------------------------------------------------------------------------------------
// Includes
//------------------------------------------------------------------------------------
